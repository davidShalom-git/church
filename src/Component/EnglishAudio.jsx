...
const DynamicEnglishVideoButton = () => {
  ...
  const fetchLatestVideo = async () => {
    try {
      ...
      const response = await fetch(`https://church-76ju.vercel.app/api/EngAudio/engAudio?t=${timestamp}`, {
        method: 'GET',
        headers: {
...
export default DynamicEnglishVideoButton;